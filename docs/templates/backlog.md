...
created: YYYY-MM-DD
promoted_to: -        # when status=promoted: point to the real artifact, e.g. story-0004 | plan-0002
---
...
> doesn't have to rethink it. When picked up, it "graduates" into a story/plan:
...
The condition that makes this worth pulling out of the backlog: "when X happens", "after plan-0002 is done",
