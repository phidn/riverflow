...
successor). Replace the old `AGENTS.md` with riverflow's `CLAUDE.md` (riverflow
uses `CLAUDE.md` only — delete `AGENTS.md` or any symlink of it). DO NOT touch
anything under
